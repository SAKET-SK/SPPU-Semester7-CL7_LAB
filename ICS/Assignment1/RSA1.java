...
public class RSA1
{
	...
	public static void main(String[] args)
	{
		...
		int p,q;
		System.out.print("Enter 'p' PrimeNumber value::");
		Scanner sc = new Scanner(System.in);
		p = sc.nextInt();
		System.out.print("Enter 'q' PrimeNumber value::");
		q = sc.nextInt();
		...
		int e;
		System.out.print("Enter 'e' PrimeNumber value::");
		e = sc.nextInt();
		int track = 0;
		...
		int plain_text;
		System.out.print("Enter the data to encrypt :: ");   //input the number to be encrypted
		//Scanner sc = new Scanner(System.in);
